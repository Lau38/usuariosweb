    ...
    return(
        <Fragment className="container-fluid">
             <div  className="fot" >
                    ...
                    <Row id="footer"  md={3}>
                        <Col className="col1"><a href="https://www.instagram.com/"><li><img src="https://i0.wp.com/eltallerdehector.com/wp-content/uploads/2022/06/cd939-logo-instagram-png.png?resize=512%2C512&ssl=1" height="40" width="50" ></img></li></a>
